Shader "Zan/UI/GrabMapDistortionFast"
{
	Properties
	{
		...
		_MultiMapDistortionVolume( "Sprite Map Distortion Volume", float) = 1.0
	...
	SubShader
	{
		...
		Pass
		{
			...
			UNITY_INSTANCING_BUFFER_START( Props)
				...
				UNITY_DEFINE_INSTANCED_PROP( half4,  _MainTexAlphaRemap)
				UNITY_DEFINE_INSTANCED_PROP( half,   _ColorBlendRatio1)
				UNITY_DEFINE_INSTANCED_PROP( half,   _AlphaBlendRatio1)
				UNITY_DEFINE_INSTANCED_PROP( half,   _BaseMapDistortionVolume)
				UNITY_DEFINE_INSTANCED_PROP( half,   _MultiMapDistortionVolume)
			...
			void vert( VertexInput v, out VertexOutput o)
			{
				...
				float4 distortionTexST = UNITY_ACCESS_INSTANCED_PROP( Props, _DistortionTex_ST);
				o.uv0.xy = v.uv0.xy * mainTexST.xy + mainTexST.zw;
				o.uv0.zw = v.uv0.xy * distortionTexST.xy + distortionTexST.zw;
			...
			fixed4 frag( VertexOutput i) : COLOR
			{
				...
				half baseVolume = UNITY_ACCESS_INSTANCED_PROP( Props, _BaseMapDistortionVolume);
				half multiVolume = UNITY_ACCESS_INSTANCED_PROP( Props, _MultiMapDistortionVolume);
